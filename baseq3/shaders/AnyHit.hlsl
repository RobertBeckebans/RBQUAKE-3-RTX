...
StructuredBuffer<STriVertex> BTriVertex :
register( t0 );
Texture2D<float4> MegaTexture :
register( t1 );
StructuredBuffer<SInstanceProperties> BInstanceProperties :
register( t2 );
...
[shader( "anyhit" )]
void InteractionAnyHit( inout HitInfo payload, Attributes attrib )
{
