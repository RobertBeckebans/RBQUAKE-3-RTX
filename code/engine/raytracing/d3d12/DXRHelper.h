...
//
//
inline ID3D12Resource* CreateBuffer( ID3D12Device* m_device, uint64_t size, D3D12_RESOURCE_FLAGS flags, D3D12_RESOURCE_STATES initState, const D3D12_HEAP_PROPERTIES& heapProps )
{
...
void GenerateMengerSponge( int32_t level, float probability, std::vector<Vertex>& outputVertices, std::vector<UINT>& outputIndices )
{
	struct Cube
	{
		...
		void	 enqueueQuad( std::vector<Vertex>& vertices, std::vector<UINT>& indices, const XMVECTOR& bottomLeft4, const XMVECTOR& dx, const XMVECTOR& dy, bool flip )
		{
			...
			vertices.push_back( { { bottomLeft.x, bottomLeft.y, bottomLeft.z, 1.f }, n, { 1.f, 0.f, 0.f, 1.f } } );
			vertices.push_back( { { bottomLeft.x + dx.m128_f32[0], bottomLeft.y + dx.m128_f32[1], bottomLeft.z + dx.m128_f32[2], 1.f }, n, { 0.5f, 1.f, 0.f, 1.f } } );
			vertices.push_back( { { bottomLeft.x + dy.m128_f32[0], bottomLeft.y + dy.m128_f32[1], bottomLeft.z + dy.m128_f32[2], 1.f }, n, { 0.5f, 0.f, 1.f, 1.f } } );

			vertices.push_back( { { bottomLeft.x + dx.m128_f32[0] + dy.m128_f32[0], bottomLeft.y + dx.m128_f32[1] + dy.m128_f32[1], bottomLeft.z + dx.m128_f32[2] + dy.m128_f32[2], 1.f },
				n,
				{ 0.f, 1.f, 0.f, 1.f } } );
		}
