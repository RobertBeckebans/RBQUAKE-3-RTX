...
void AAS_SetTexinfo( mapbrush_t* brush )
{
	...
	if( brush->contents & ( CONTENTS_LADDER | CONTENTS_AREAPORTAL | CONTENTS_CLUSTERPORTAL | CONTENTS_TELEPORTER | CONTENTS_JUMPPAD | CONTENTS_DONOTENTER | CONTENTS_WATER | CONTENTS_LAVA |
...
void AAS_CreateMapBrushes( mapbrush_t* brush, entity_t* mapent, int addbevels )
{
	...
	if( !( brush->contents & ( CONTENTS_SOLID | CONTENTS_LADDER | CONTENTS_CLUSTERPORTAL | CONTENTS_DONOTENTER | CONTENTS_TELEPORTER | CONTENTS_JUMPPAD | CONTENTS_WATER | CONTENTS_LAVA |
